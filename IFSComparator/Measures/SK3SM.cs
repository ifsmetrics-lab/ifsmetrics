...
namespace IFSComparer.Measures
{
    ...
    public class SK3SM : IFSMeasure
    {
        ...
        public enum SK3SMType
        {
            TwoDimensions,
            ThreeDimensions
        }

        SK3SMType _type = SK3SMType.ThreeDimensions;

		public SK3SMType SK3Type{
			get{return _type; }
			set{ _type = value; }
		}
        ...
        public SK3SM()
        {
            _type = SK3SMType.ThreeDimensions;
			base.CiteKey = _CITEKEY;
			base.Cite = _CITE;
        }


        public SK3SM(SK3SMType type)
        {
            _type = type;
			base.CiteKey = _CITEKEY;
			base.Cite = _CITE;
        ...
        public override double GetSimilarity(IFS P, IFS Q)
        {
            ...
            if (_type == SK3SMType.ThreeDimensions)
            {
            ...
            if (d1 + d2 > 0)
            {
                ret = Math.Pow( (1 - f(d1, d2)),2) / Math.Pow( (1 + f(d1, d2)),2);
            }
            return ret;
        }
