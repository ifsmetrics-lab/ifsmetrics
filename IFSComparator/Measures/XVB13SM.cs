...
namespace IFSComparator.Measures
{
    ...
    class XVB13SM : IFSMeasure
    {
        ...
        public XVB13SM(Double alpha, Double beta, Double delta, int k)
        {
            _alpha = alpha;
            _delta = delta;
            _isDirty = true;
