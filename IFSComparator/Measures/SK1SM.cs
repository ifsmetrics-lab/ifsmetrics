...
namespace IFSComparer.Measures
{
    ...
    public class SK1SM: IFSMeasure
    {
        ...
        public enum SK1SMType
        {
            TwoDimensions,
            ThreeDimensions
        }

        SK1SMType _type = SK1SMType.ThreeDimensions;

		public SK1SMType SK1Type{
			get{return _type; }
			set{ _type = value; }
		}
        ...
        public SK1SM()
        {
            _type = SK1SMType.ThreeDimensions;
			base.CiteKey = _CITEKEY;
			base.Cite = _CITE;
        }


        public SK1SM(SK1SMType type)
        {
            _type = type;
			base.CiteKey = _CITEKEY;
			base.Cite = _CITE;
        ...
        public override double GetSimilarity(IFS P, IFS Q)
        {
            ...
            if (_type == SK1SMType.ThreeDimensions)
            {
