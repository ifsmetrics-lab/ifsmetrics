...
namespace IFSComparer.Measures
{
    ...
    public class SK2SM : IFSMeasure
    {
        ...
        public enum SK2SMType
        {
            TwoDimensions,
            ThreeDimensions
        }

        SK2SMType _type = SK2SMType.ThreeDimensions;

		public SK2SMType SK2Type{
			get{return _type; }
			set{ _type = value; }
		}
        ...
        public SK2SM()
        {
            _type = SK2SMType.ThreeDimensions;
			base.CiteKey = _CITEKEY;
			base.Cite = _CITE;
        }


        public SK2SM(SK2SMType type)
        {
            _type = type;
			base.CiteKey = _CITEKEY;
			base.Cite = _CITE;
        ...
        public override double GetSimilarity(IFS P, IFS Q)
        {
            ...
            if (_type == SK2SMType.ThreeDimensions)
            {
